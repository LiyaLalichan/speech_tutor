"""
Django settings for speech_tutor project.
...
SECRET_KEY = 'django-insecure-fq3ko)dj9lxs_f5rh3#rswsmkrx7(*)0g&q^xpi0+cvo96=%wh'
...
ROOT_URLCONF = 'speech_tutor.urls'
...
WSGI_APPLICATION = 'speech_tutor.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'speech_tutor_db',  # Your MySQL database name
        'USER': 'root',  # Change if using another MySQL user
        'PASSWORD': 'Annliya12@',  # Replace with your MySQL password
